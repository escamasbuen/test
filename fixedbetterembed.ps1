...
$basicinfoString = (Get-Content -Path $basicinfo) | Out-String

$username = "C:\Users\$env:username\AppData\Roaming\.minecraft\username.txt"
$usernameString = (Get-Content -Path $username) | Out-String
...
$thumbUrl = 'https://minotar.net/helm/'+$usernameString+'/600.png' 
